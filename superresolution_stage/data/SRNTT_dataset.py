...
class SRNTTDataset(data.Dataset):
    """
    ...
    def __init__(self, opt):
        super(SRNTTDataset, self).__init__()
        self.opt = opt
        self.data_type = self.opt['data_type']
        self.paths_LQ, self.paths_Ref_DUX4, self.paths_LQ_UX4, self.paths_Ref, self.paths_SR, self.paths_GT = None, None, None, None, None, None
        self.sizes_LQ, self.sizes_Ref_DUX4, self.sizes_LQ_UX4, self.sizes_Ref, self.sizes_SR, self.sizes_GT = None, None, None, None, None, None
        self.LQ_env, self.Ref_DUX4_env, self.LQ_UX4_env, self.Ref_env, self.SR_env, self.GT_env = None, None, None, None, None, None  # environments for lmdb
    ...
    def __getitem__(self, index):
        if self.data_type == 'lmdb' and (self.GT_env is None or self.LQ_UX4_env is None):
            self._init_lmdb()
        LQ_path, GT_path, LQ_UX4_path, Ref_path, SR_path, Ref_DUX4_path = None, None, None, None, None, None
        ...
        if self.opt['phase'] == 'train':
            ...
            img_SR = img_SR[rnd_h:rnd_h + GT_size, rnd_w:rnd_w + GT_size, :]
            ...
            img_LQ, img_Ref_DUX4, img_LQ_UX4, img_Ref, img_SR, img_GT = util.augment([img_LQ, img_Ref_DUX4, img_LQ_UX4, img_Ref, img_SR, img_GT], self.opt['use_flip'],
                                          self.opt['use_rot'])
        ...
        return {'Ref_DUX4': img_Ref_DUX4, 'LQ': img_LQ, 'LQ_UX4': img_LQ_UX4,'Ref': img_Ref, 'SR': img_SR, 'GT': img_GT, 'Ref_DUX4_path':Ref_DUX4_path, 'LQ_path': LQ_path, 'LQ_UX4_path': LQ_UX4_path, 'Ref_path': Ref_path, 'SR_path': SR_path, 'GT_path': GT_path}
