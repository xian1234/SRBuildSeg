...
def main():
    dataset = 'jinan_train'  # vimeo90K | REDS | general (e.g., DIV2K, 291) | DIV2K_demo |test
    ...
    if dataset == 'vimeo90k':
        ...
        opt = {}
        opt['img_folder'] = '../../dataset/sub/DIV2K800_sub'
        opt['lmdb_save_path'] = '../../dataset/sub/DIV2K800_sub.lmdb'
        opt['name'] = 'DIV2K800_sub_GT'
        general_image_folder(opt)
    elif dataset == 'jinan_val':
        opt = {}
        ## GT
        data_path = '/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/val_data/use_data/'
        lmdb_path = '/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/val_data/use_lmdb/'
        fold_list = glob.glob('/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/val_data/use_data/*')
        print(fold_list)
        for path in fold_list:
            ...
            general_image_folder(opt) 
    elif dataset == 'jinan_train':
        opt = {}
        ## GT
        data_path = '/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/train_data/use_data/'
        lmdb_path = '/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/train_data/use_lmdb/'
        fold_list = glob.glob('/mnt/lustrenew/dongrunmin/dongrunmin/SR/dataset/RefSR_data/jinan_L18/train_data/use_data/*')
        print(fold_list)
        for path in fold_list:
            base_name = osp.basename(path)
            print(base_name)
